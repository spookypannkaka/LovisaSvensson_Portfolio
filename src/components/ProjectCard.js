...
<g>
	<path d="M412.642,345.939l-59.523-14.229l-66.352-66.352l51.12-51.055c11.874,4.167,24.216,6.203,36.499,6.202
		...
		l49.498,49.499l-24.081,24.081L373.342,397.227z" fill="#D4FAFF"/>
</g>
</svg>
    );
}
...
function ArrowIcon() {
    return (
        <svg className="arrow-icon" height="20" width="20" viewBox="0 0 330 330">
...
const readMoreStyle = {
    position: 'absolute', // Position relative to cardContent
    bottom: '10px', // Adjust as necessary for spacing from the bottom
    right: '15px', // Adjust as necessary for spacing from the right
    color: '#3c4059', // Match the color scheme of your card
